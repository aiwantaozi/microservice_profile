...
var (
	...
	serverAddr = flag.String("server_addr", "127.0.0.1:9081", "The server address in the format of host:port")
	// serverHostOverride = flag.String("server_host_override", "x.test.youtube.com", "The server name use to verify the hostname returned by TLS handshake")
)

// printFeature gets the feature for the given point.
func profileInstanceGet(client proto_profile.ProfileServiceClient, userId string) {
	feature, err := client.ProfileInstanceGet(context.Background(), point)
	if err != nil {
